...
namespace sakila.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(SakilaContext context)
        {
            _context = context;
        }
        ...
        {
            var sakilaContext = _context.Payment.Include(p => p.Customer).Include(p => p.Rental).Include(p => p.Staff);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,CustomerId,StaffId,RentalId,Amount,PaymentDate,LastUpdate")] Payment payment)
        {
